...
import { h as createComponent, n as ShadowDomTargetContext, t as DevtoolsOnCloseContext, u as render, x as lazy, y as createSignal } from "./context-CP5pFKVs.js";
import "./root-DaK8jZe-.js";
import { it as useRouter, rt as useRouterState } from "./esm-DT8SKlTZ.js";
	...
	mount(el) {
		...
		const dispose = render(() => {
			...
			if (__privateGet$1(this, _Component$1)) Devtools = __privateGet$1(this, _Component$1);
				...
				Devtools = lazy(() => import("./FloatingTanStackRouterDevtools-Lu22lw5R.js"));
	...
	mount(el) {
		...
		const dispose = render(() => {
			...
			if (__privateGet(this, _Component)) BaseTanStackRouterDevtoolsPanel = __privateGet(this, _Component);
				...
				BaseTanStackRouterDevtoolsPanel = lazy(() => import("./BaseTanStackRouterDevtoolsPanel-Dw6GT0GE.js"));
