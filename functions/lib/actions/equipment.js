...
exports.listEquipmentByCompany = exports.deleteEquipment = exports.updateEquipment = exports.getEquipment = exports.createEquipment = void 0;
const admin_db_1 = require("../lib/admin-db");
const _base_1 = require("./_base");
const enums_1 = require("../types/enums");
const validators_1 = require("../lib/validators");
const COLLECTION = "equipment";
async function _createEquipment(ctx, input) {
    var _a;
...
exports.deleteEquipment = (0, _base_1.withValidation)(validators_1.DeleteByIdSchema, (0, _base_1.withAuth)(MGMT, _deleteEquipment));
exports.listEquipmentByCompany = (0, _base_1.withValidation)(validators_1.ListByCompanySchema, (0, _base_1.withAuth)(READ, _listEquipmentByCompany));
