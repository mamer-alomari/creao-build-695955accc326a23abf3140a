...
import "./root-BxNBUuLL.js";
import { it as useRouter, rt as useRouterState } from "./esm-OjWEHceg.js";
	...
	mount(el) {
		...
		const dispose = render(() => {
			...
			if (__privateGet$1(this, _Component$1)) Devtools = __privateGet$1(this, _Component$1);
				...
				Devtools = lazy(() => import("./FloatingTanStackRouterDevtools-Cv7vFPTp.js"));
	...
	mount(el) {
		...
		const dispose = render(() => {
			...
			if (__privateGet(this, _Component)) BaseTanStackRouterDevtoolsPanel = __privateGet(this, _Component);
				...
				BaseTanStackRouterDevtoolsPanel = lazy(() => import("./BaseTanStackRouterDevtoolsPanel-bU3dSrQa.js"));
