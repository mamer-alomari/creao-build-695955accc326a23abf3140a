import { C as useContext, S as mergeProps, _ as createMemo, a as addEventListener, c as insert, d as setAttribute, f as spread, g as createEffect, h as createComponent, l as memo, m as Show, n as ShadowDomTargetContext, o as className, p as template, r as useDevtoolsOnClose, s as delegateEvents, v as createRenderEffect, y as createSignal } from "./context-CP5pFKVs.js";
import { E as invariant, f as trimPath, i as interpolatePath, t as rootRouteId } from "./root-DaK8jZe-.js";
import { t as clsx } from "./clsx-C5TVX08Y.js";

//#region node_modules/goober/dist/goober.modern.js
var e = { data: "" }, t = (t$1) => "object" == typeof window ? ((t$1 ? t$1.querySelector("#_goober") : window._goober) || Object.assign((t$1 || document.head).appendChild(document.createElement("style")), {
	innerHTML: " ",
	id: "_goober"
})).firstChild : t$1 || e, r = (e$1) => {
...
//#endregion
//#region node_modules/@tanstack/router-devtools-core/dist/esm/tokens.js
var tokens = {
	colors: {
		inherit: "inherit",
...
//#endregion
//#region node_modules/@tanstack/router-devtools-core/dist/esm/useStyles.js
...
//#endregion
//#region node_modules/@tanstack/router-devtools-core/dist/esm/useLocalStorage.js
var getItem = (key) => {
	try {
...
//#endregion
//#region node_modules/@tanstack/router-devtools-core/dist/esm/utils.js
...
//#endregion
//#region node_modules/@tanstack/router-devtools-core/dist/esm/Explorer.js
		...
		insert(_el$3, (() => {
			...
			return () => _c$() ? [(() => {
				...
				insert(_el$8, () => subEntryPages().map((entries, index) => {
					return (() => {
						var _el$9 = _tmpl$4$1(), _el$10 = _el$9.firstChild, _el$11 = _el$10.firstChild, _el$12 = _el$11.firstChild, _el$17 = _el$12.nextSibling, _el$18 = _el$17.nextSibling.nextSibling;
						_el$18.nextSibling;
						_el$11.$$click = () => setExpandedPages((old) => old.includes(index) ? old.filter((d$1) => d$1 !== index) : [...old, index]);
						insert(_el$11, createComponent(Expander, { get expanded() {
				...
				return () => _c$2() ? createComponent(Explorer, {
					get label() {
						return (() => {
							var _el$20 = _tmpl$5$1(), _el$21 = _el$20.firstChild;
					...
					(() => {
						var _el$22 = _tmpl$6$1(), _el$23 = _el$22.firstChild;
						insert(_el$22, () => rest.label, _el$23);
						return _el$22;
					})(),
					" ",
					(() => {
						var _el$24 = _tmpl$7$1();
...
//#endregion
//#region node_modules/@tanstack/router-devtools-core/dist/esm/AgeTicker.js
...
//#endregion
//#region node_modules/@tanstack/router-devtools-core/dist/esm/NavigateButton.js
...
//#endregion
//#region node_modules/@tanstack/router-devtools-core/dist/esm/BaseTanStackRouterDevtoolsPanel.js
...
function RouteComp({ routerState, router, route, isRoot, activeId, setActiveId }) {
	...
	const param = createMemo(() => {
		...
		try {
			if ((_a = match()) == null ? void 0 : _a.params) {
				const p$1 = (_b = match()) == null ? void 0 : _b.params;
	...
	return (() => {
		...
		insert(_el$6, (() => {
			...
			return () => _c$() ? (() => {
				var _el$12 = _tmpl$6();
				insert(_el$12, () => [...route.children].sort((a$1, b$1) => {
...
var BaseTanStackRouterDevtoolsPanel = function BaseTanStackRouterDevtoolsPanel2({ ...props }) {
	...
	return (() => {
		...
		insert(_el$20, (() => {
			...
			return () => _c$5() ? (() => {
				var _el$40 = _tmpl$10(), _el$41 = _el$40.firstChild, _el$43 = _el$41.firstChild.nextSibling, _el$44 = _el$41.nextSibling;
		...
		insert(_el$13, (() => {
			...
			return () => _c$6() ? (() => {
				var _el$48 = _tmpl$11(), _el$49 = _el$48.firstChild, _el$50 = _el$49.nextSibling, _el$51 = _el$50.firstChild, _el$52 = _el$51.firstChild, _el$53 = _el$52.firstChild, _el$54 = _el$52.nextSibling, _el$56 = _el$54.firstChild.nextSibling, _el$57 = _el$56.firstChild, _el$58 = _el$54.nextSibling, _el$60 = _el$58.firstChild.nextSibling, _el$61 = _el$58.nextSibling, _el$63 = _el$61.firstChild.nextSibling, _el$64 = _el$50.nextSibling, _el$65 = _el$64.nextSibling;
				insert(_el$53, (() => {
					var _c$8 = memo(() => {
						var _a, _b;
				...
				insert(_el$60, (() => {
					var _c$9 = memo(() => {
						var _a;
						return !!((_a = routerState().pendingMatches) == null ? void 0 : _a.find((d$1) => {
							var _a2;
							return d$1.id === ((_a2 = activeMatch()) == null ? void 0 : _a2.id);
						}));
					});
					return () => _c$9() ? "Pending" : routerState().matches.find((d$1) => {
						var _a;
						return d$1.id === ((_a = activeMatch()) == null ? void 0 : _a.id);
					}) ? "Active" : "Cached";
				})());
				insert(_el$63, (() => {
					var _c$10 = memo(() => {
...
//#endregion
export { useStyles as i, useIsMounted as n, useLocalStorage as r, BaseTanStackRouterDevtoolsPanel as t };
//# sourceMappingURL=BaseTanStackRouterDevtoolsPanel-DHxF8Tz8.js.map