...
function getNextElement(template$1) {
	...
	if (!hydrating || !(node = sharedConfig.registry.get(key = getHydrationKey()))) {
		if (hydrating) {
			...
			throw new Error(`Hydration Mismatch. Unable to find DOM nodes for hydration key: ${key}\n${template$1 ? template$1().outerHTML : ""}`);
		}
		return template$1();
	}
...
function createDynamic(component, props) {
	...
	return createMemo(() => {
		...
		switch (typeof component$1) {
			case "function":
				Object.assign(component$1, { [$DEVCOMP]: true });
				return untrack(() => component$1(props));
			case "string":
				const isSvg = SVGElements.has(component$1);
				const el = sharedConfig.context ? getNextElement() : createElement(component$1, isSvg);
...
//#endregion
//#region node_modules/@tanstack/router-devtools-core/dist/esm/context.js
...
//#endregion
export { useContext as C, mergeProps as S, createMemo as _, addEventListener as a, createUniqueId as b, insert as c, setAttribute as d, spread as f, createEffect as g, createComponent as h, Dynamic as i, memo as l, Show as m, ShadowDomTargetContext as n, className as o, template as p, useDevtoolsOnClose as r, delegateEvents as s, DevtoolsOnCloseContext as t, render as u, createRenderEffect as v, lazy as x, createSignal as y };
//# sourceMappingURL=context-CP5pFKVs.js.map